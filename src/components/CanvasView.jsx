                ...
                <div className="bg-[var(--bg-card)]/90 backdrop-blur-xl border border-[var(--border-color)] p-2 rounded-2xl shadow-2xl flex flex-col gap-2">
                    {FILTERS.map(filter => (
                        <button
                            ...
                            className={`group relative w-10 h-10 rounded-xl transition-all duration-200 flex items-center justify-center focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:outline-none ${activeFilter.id === filter.id
