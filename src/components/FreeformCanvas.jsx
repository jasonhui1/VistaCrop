...
function FreeformCanvas({
    ...
    // Create an O(1) lookup map for crops to optimize drag performance
    ...
    }, [dragState, onUpdateItem, onUpdateItemSilent, cropsMap, placedItems, composition.pageWidth, composition.pageHeight])
