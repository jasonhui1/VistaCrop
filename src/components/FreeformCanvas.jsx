...
const RotatableImage = memo(function RotatableImage({ crop, originalImage, currentRotation, isRotating, getFilterStyle }) {
    ...
    const rotationDisplayData = useMemo(() => {
        ...
        const scaleX = crop.width > 0 ? containerWidth / crop.width : 1
        const scaleY = crop.height > 0 ? containerHeight / crop.height : 1
    ...
    }, [currentRotation, originalImage, containerSize, crop.width, crop.height, crop.x, crop.y, crop.originalImageWidth, crop.originalImageHeight])
        ...
        >
            ...
            {rotationDisplayData ? (
                <>
                    ...
                    >
                        {/* Original image that rotates - using PIXEL values like gallery mode */}
                        <div
                            style={{
                                position: 'absolute',
                        ...
                        <div style={{ position: 'absolute', top: -2, left: -2, width: 8, height: 8, backgroundColor: 'white', borderRadius: '50%', boxShadow: '0 2px 4px rgba(0,0,0,0.5)' }} />
                        <div style={{ position: 'absolute', top: -2, right: -2, width: 8, height: 8, backgroundColor: 'white', borderRadius: '50%', boxShadow: '0 2px 4px rgba(0,0,0,0.5)' }} />
                        <div style={{ position: 'absolute', bottom: -2, left: -2, width: 8, height: 8, backgroundColor: 'white', borderRadius: '50%', boxShadow: '0 2px 4px rgba(0,0,0,0.5)' }} />
                        <div style={{ position: 'absolute', bottom: -2, right: -2, width: 8, height: 8, backgroundColor: 'white', borderRadius: '50%', boxShadow: '0 2px 4px rgba(0,0,0,0.5)' }} />
                    </div>
                </>
            ) : (
