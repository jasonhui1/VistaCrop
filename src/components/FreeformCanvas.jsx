...
function FreeformCanvas({
    ...
    const handleMouseMove = useCallback((e) => {
        ...
        if (dragState.type === 'corner' && dragState.cornerIndex !== undefined) {
            const currentPoints = dragState.currentPoints

            const itemWidthPx = (dragState.startItemWidth / composition.pageWidth) * rect.width
            const itemHeightPx = (dragState.startItemHeight / composition.pageHeight) * rect.height
