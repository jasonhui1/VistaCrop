                    ...
                    <div>
                        ...
                        <div className="flex rounded-lg overflow-hidden border border-[var(--border-color)]">
                            <button
                                ...
                                className={`flex-1 py-2 text-xs font-medium transition-colors relative focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] ${mode === 'freeform'
                            ...
                            <button
                                ...
                                className={`flex-1 py-2 text-xs font-medium transition-colors relative focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] ${mode === 'panels'
                                    ? 'bg-[var(--accent-primary)] text-white'
                                    : 'bg-[var(--bg-tertiary)] text-[var(--text-secondary)] hover:text-white'
                                    }`}
                            >
