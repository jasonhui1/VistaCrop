                    ...
                    <>
                        <button
                            ...
                            className={`text-xs px-2 py-1 rounded transition-colors ${canUndo
                                ...
                                } focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative focus-visible:z-10`}
                            title="Undo (Ctrl+Z)"
                            aria-label="Undo"
                        >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className={`ml-2 p-1 rounded transition-colors ${deleteConfirmId === canvas.id
                                                ...
                                                } focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:outline-none relative focus-visible:z-10`}
