                                ...
                                savedCanvases.map((canvas) => (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            className={`ml-2 p-1 rounded transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[var(--accent-primary)] ${deleteConfirmId === canvas.id
