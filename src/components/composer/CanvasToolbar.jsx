        ...
        <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
                ...
                {mode === 'freeform' && (
                    <>
                        <button
                            ...
                            disabled={!canUndo}
                            aria-label="Undo"
                            className={`text-xs px-2 py-1 rounded transition-colors focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative z-10 ${canUndo
                        ...
                        <button
                            ...
                            disabled={!canRedo}
                            aria-label="Redo"
                            className={`text-xs px-2 py-1 rounded transition-colors focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative z-10 ${canRedo
                                ? 'bg-[var(--bg-tertiary)] text-[var(--text-muted)] hover:text-white'
                                : 'bg-[var(--bg-tertiary)] text-[var(--text-muted)] opacity-40 cursor-not-allowed'
                                }`}
                            title="Redo (Ctrl+Y)"
                ...
                {mode === 'freeform' && itemCount > 0 && (
                    <button
                        onClick={onClear}
                        className="text-xs px-2 py-1 rounded bg-[var(--bg-tertiary)] text-[var(--text-muted)] hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative z-10"
                    >
                        Clear
                    </button>
                )}
                ...
                {mode === 'freeform' && (
                    <button
                        ...
                        className={`text-xs px-2 py-1 rounded transition-colors focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative z-10 ${editingCanvasSize
                                ...
                                savedCanvases.map((canvas) => (
                                    ...
                                    >
                                        <button
                                            ...
                                            className={`flex-1 text-left rounded focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative z-10 ${canvas.id === canvasId ? 'text-[var(--accent-primary)]' : 'text-[var(--text-secondary)]'}`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`ml-2 p-1 rounded transition-colors focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative z-10 ${deleteConfirmId === canvas.id
                ...
                <button
                    onClick={onSave}
                    disabled={isSaving}
                    className={`text-xs px-3 py-1.5 rounded transition-colors flex items-center gap-1 focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative z-10 ${canvasId
                ...
                <button
                    onClick={onExport}
                    className="text-xs px-3 py-1.5 rounded bg-[var(--accent-primary)] text-white hover:bg-[var(--accent-secondary)] transition-colors flex items-center gap-1 focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none relative z-10"
                >
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
