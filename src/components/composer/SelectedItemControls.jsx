                    ...
                    <div className="mt-2 p-2 rounded-lg bg-[var(--bg-tertiary)] space-y-1.5">
                        ...
                        <div className="flex gap-1">
                            ...
                            <button
                                ...
                                className="px-2 py-1.5 text-xs rounded bg-[var(--bg-primary)] text-[var(--text-muted)] hover:text-red-400 transition-colors focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:outline-none"
