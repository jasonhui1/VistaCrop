      ...
      <header className="glass-card px-4 py-2 flex items-center justify-between border-b border-[var(--border-color)] rounded-none">
        ...
        <div className="flex items-center gap-2 bg-[var(--bg-tertiary)] rounded-xl p-1">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] relative z-10 ${view === 'canvas'
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] relative z-10 ${view === 'gallery'
              ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-lg'
              : 'text-[var(--text-secondary)] hover:text-white'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] relative z-10 ${view === 'composer'
              ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-lg'
              : 'text-[var(--text-secondary)] hover:text-white'
              }`}
          >
